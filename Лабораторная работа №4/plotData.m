...
plot(XOnes(:,1), XOnes(:,2), 'rs', 'MarkerSize', 10, 'MarkerEdgeColor', 'yellow', 'MarkerFaceColor', 'yellow');
plot(XZeros(:,1), XZeros(:, 2), 'ko', 'MarkerSize', 10, 'MarkerEdgeColor', 'red', 'MarkerFaceColor', 'red');
